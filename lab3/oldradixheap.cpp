...
long long *radixheap(int s, int &n, int &m,
    ...
    std::vector<std::list<int>> content(K + 1);
...
//./radixheap -d inputs/Long-n/Long-n.10.0.gr -ss inputs/Long-n/Long-n.10.0.ss
//-oss dupa.ss.res
//./radixheap -d inputs/Long-n/Long-n.14.0.gr -p2p inputs/Long-n/Long-n.14.0.p2p
//-op2p dupa.p2p.res
